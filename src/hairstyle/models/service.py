...
class ServiceLabel(models.Model):
    service = models.ForeignKey(Service, on_delete=models.CASCADE, related_name="ServiceLabels")
    label = models.ForeignKey(Label, on_delete=models.CASCADE, related_name="ServiceLabels")
    created_at = models.DateTimeField(auto_now_add=True)
...
class ServiceImage(models.Model):
    ...
    image = models.ForeignKey(File, on_delete=models.CASCADE, related_name="ServiceImages")
